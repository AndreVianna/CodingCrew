...
from .current_thread_executor import CurrentThreadExecutor # pylint: disable=relative-beyond-top-level
from .local import Local # pylint: disable=relative-beyond-top-level
...
if hasattr(inspect, "markcoroutinefunction"):
    ...
    def markcoroutinefunction(func: _F) -> _F:
        func._is_coroutine = asyncio.coroutines._is_coroutine  # pylint: disable=protected-access
        return func
